    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">Create New Endpoint</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('endpoints.endpoint.store') }}" accept-charset="UTF-8" id="create_endpoint_form" name="create_endpoint_form" class="form-horizontal">
            {{ csrf_field() }}
